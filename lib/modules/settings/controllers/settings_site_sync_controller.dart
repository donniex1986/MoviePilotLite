...
import 'package:moviepilot_mobile/modules/settings/models/settings_site_sync_config.dart';
...
class SettingsSiteSyncController extends GetxController {
  ...
  late final SettingsFormManager form = SettingsFormManager(
    fields: siteSyncConfigFields,
  );

  List<SettingsFieldConfig> get fields => siteSyncConfigFields;
  ...
  Future<bool> updateEnv(Map<String, dynamic> changes) async {
    ...
    final interval = data['COOKIECLOUD_INTERVAL'];
    if (interval != null) {
      data['COOKIECLOUD_INTERVAL'] = interval is int
          ? interval
