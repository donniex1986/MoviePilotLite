...
import 'package:moviepilot_mobile/modules/settings/models/settings_search_download_config.dart';
import 'package:moviepilot_mobile/modules/settings/models/system_env_model.dart';
import 'package:moviepilot_mobile/services/api_client.dart';

class SettingsSearchDownloadController extends GetxController {
  ...
  List<SettingsFieldConfig> get fields => searchDownloadConfigFields;
  ...
  bool shouldShowField(SettingsFieldConfig field) => true;

  List<SettingsFieldConfig> visibleFields() =>
      fields.where(shouldShowField).toList();
}
