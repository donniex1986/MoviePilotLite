...
/// 站点同步设置页
/// 从 CookieCloud 快速同步站点数据
class SiteSyncPage extends GetView<SettingsSiteSyncController> {
  const SiteSyncPage({super.key});
